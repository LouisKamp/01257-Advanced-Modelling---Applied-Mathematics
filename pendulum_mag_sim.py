...
class Pendulum():
    ...
    def __init__(self, M_p: float, l: float, mu_0: float, g: float, alpha: float):
        self.M_p = M_p
        self.l = l
        self.mu_0 = mu_0
        self.g = g
